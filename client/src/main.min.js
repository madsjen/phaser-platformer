...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainState = __webpack_require__(1);
	...
	var AwesomeGame = function (_Phaser$Game) {
		_inherits(AwesomeGame, _Phaser$Game);
	
		function AwesomeGame() {
			_classCallCheck(this, AwesomeGame);
	
			var _this = _possibleConstructorReturn(this, (AwesomeGame.__proto__ || Object.getPrototypeOf(AwesomeGame)).call(this, 1200, 700, Phaser.AUTO, 'content', null));
	
			_this.state.add('main', _GameState2.default, false);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LobbyState = __webpack_require__(58);
	...
	var MainState = function (_Phaser$State) {
	  ...
	  _createClass(MainState, [{
	    ...
	    value: function create() {
	      ...
	      var joinBtn = this.game.add.text(500, 300, 'Join lobby');
	      joinBtn.inputEnabled = true;
	      joinBtn.addColor('#fff', 0);
	      joinBtn.events.onInputDown.add(this.startGame.bind(this));
	
	      var createBtn = this.game.add.text(500, 350, 'Create lobby');
	    ...
	    key: 'createLobby',
	    value: function createLobby() {
	      var lobbyName = prompt('Lobby name');
	      this.state.add('lobby', _LobbyState2.default, false);
	      this.state.start('lobby');
	    }
	  }, {
	    key: 'startGame',
	    value: function startGame() {
	      this.state.add('game', _GameState2.default, false);
	...
	var GameState = function (_Phaser$State) {
	  ...
	  _createClass(GameState, [{
	    ...
	    value: function create() {
	      ...
	      this.player = new _Player2.default(this, 100, 245);
	    }
	  }, {
	    key: 'update',
	    value: function update() {
	    ...
	    key: 'addPlatforms',
	    value: function addPlatforms(x, y, amount) {
	      for (var i = 0; i < amount; i++) {
	        this.platforms.add(new _Platform2.default(this.game, x, y));
	        x += 20;
	      }
	    }
...
/***/ function(module, exports) {
	...
	var Player = function (_Phaser$Sprite) {
	  ...
	  function Player(state, x, y) {
	    ...
	    var _this = _possibleConstructorReturn(this, (Player.__proto__ || Object.getPrototypeOf(Player)).call(this, state.game));
	    ...
	    _this.player = game.add.sprite(x, y, 'player');
	    ...
	    // walk left
	    _this.aKey = game.input.keyboard.addKey(Phaser.Keyboard.A);
	    _this.aKey.onDown.add(_this.walk, _this);
	    _this.aKey.onUp.add(_this.walk, _this);
	
	    // walk right
	    _this.dKey = game.input.keyboard.addKey(Phaser.Keyboard.D);
	    _this.dKey.onDown.add(_this.walk, _this);
	    _this.dKey.onUp.add(_this.walk, _this);
	
	    // jump
	    _this.spaceKey = game.input.keyboard.addKey(Phaser.Keyboard.W);
	    _this.spaceKey.onDown.add(_this.jump, _this);
...
/***/ function(module, exports) {
	...
	var Platform = function (_Phaser$Sprite) {
	  ...
	  function Platform(game, x, y) {
	    ...
	    var platform = _this.game.add.sprite(x, y, 'platform');
	    ...
	    return _ret = platform, _possibleConstructorReturn(_this, _ret);
	  }
	...
	var LobbyState = function (_Phaser$State) {
	   ...
	   _createClass(LobbyState, [{
	      ...
	      value: function create() {
	         ...
	         var joinBtn = this.game.add.text(500, 100, 'This is a lobby');
	         joinBtn.inputEnabled = true;
	         joinBtn.addColor('#fff', 0);
	      }
	   }, {
